...
func InitializeServe(ctx context.Context, cfg config.Config) (*ServeRuntime, func(), error) {
	...
	deviceLists := provideDeviceLists(deviceList, roomMember, repositoryEvent, transactor, deviceListStream, notifier)
	...
	stores := provideSyncStores(toDevice, accountData, repositoryReceipt, repositoryTyping, repositoryKey)
	...
	serviceSync := provideSync(repositoryConnection, roomMember, repositoryEvent, serviceTimeline, transactor, stream, notifier, serialiser, deviceLists, stores, streams, sync, v)
	legacysyncStores := provideLegacyStores(roomMember, repositoryEvent, toDevice, accountData, repositoryReceipt, repositoryTyping, repositoryKey)
	legacysyncStreams := provideLegacyStreams(stream, toDeviceStream, deviceListStream, accountDataStream, receiptStream)
	legacySync := provideLegacySync(legacysyncStores, legacysyncStreams, serviceTimeline, deviceLists, transactor, notifier, sync, v)
	keys := provideKeysConfig(cfg)
	serviceKeys := provideKeys(repositoryKey, transactor, deviceLists, keys)
	...
	toDeviceLimits := provideToDeviceLimits(limits)
	serviceToDevice := provideToDevice(toDevice, repositoryDevice, transactor, toDeviceStream, notifier, valkeyClient, toDeviceLimits, v)
