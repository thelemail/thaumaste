...
type User struct {
	...
	Localpart     string    `boil:"localpart" json:"localpart" toml:"localpart" yaml:"localpart"`
...
var UserWhere = struct {
	...
	Localpart:     whereHelperstring{field: "\"users\".\"localpart\""},
	DisplayName:   whereHelperstring{field: "\"users\".\"display_name\""},
	AvatarURL:     whereHelperstring{field: "\"users\".\"avatar_url\""},
	DeactivatedAt: whereHelpernull_Time{field: "\"users\".\"deactivated_at\""},
...
var (
	userAllColumns            = []string{"tenant_id", "user_id", "localpart", "display_name", "avatar_url", "deactivated_at", "created_at"}
	userColumnsWithoutDefault = []string{"tenant_id", "user_id", "localpart"}
	userColumnsWithDefault    = []string{"display_name", "avatar_url", "deactivated_at", "created_at"}
	userPrimaryKeyColumns     = []string{"tenant_id", "user_id"}
...
func (userL) LoadTenant(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (o *User) SetTenant(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tenant) error {
	...
	values := []any{related.ID, o.TenantID, o.UserID}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, tenantID string, userID string, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"tenant_id\"=$1 AND \"user_id\"=$2", sel,
	)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"users\" WHERE \"tenant_id\"=$1 AND \"user_id\"=$2"
...
func (o *User) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUser(ctx, exec, o.TenantID, o.UserID)
	if err != nil {
		return err
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, tenantID string, userID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"tenant_id\"=$1 AND \"user_id\"=$2 limit 1)"
...
func (o *User) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserExists(ctx, exec, o.TenantID, o.UserID)
}
