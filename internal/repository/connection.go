...
type Connection interface {
	...
	Acknowledge(ctx context.Context, connectionNID, generation int64, cursors entity.SyncCursors) error
	Discard(ctx context.Context, connectionNID int64) error
	Reset(ctx context.Context, connectionNID int64) error
	Stage(ctx context.Context, connectionNID, generation int64, cursors entity.SyncCursors, rooms []entity.NewRoomStatus) error
