...
type UserCredential struct {
	...
	Params    string    `boil:"params" json:"params" toml:"params" yaml:"params"`
...
var UserCredentialTableColumns = struct {
	...
	TenantID:  "user_credentials.tenant_id",
	UserID:    "user_credentials.user_id",
	Algorithm: "user_credentials.algorithm",
	Params:    "user_credentials.params",
...
var UserCredentialWhere = struct {
	...
	Params    whereHelperstring
	Salt      whereHelper__byte
	Hash      whereHelper__byte
	UpdatedAt whereHelpertime_Time
}{
	TenantID:  whereHelperstring{field: "\"user_credentials\".\"tenant_id\""},
	UserID:    whereHelperstring{field: "\"user_credentials\".\"user_id\""},
	Algorithm: whereHelperstring{field: "\"user_credentials\".\"algorithm\""},
	Params:    whereHelperstring{field: "\"user_credentials\".\"params\""},
	Salt:      whereHelper__byte{field: "\"user_credentials\".\"salt\""},
	Hash:      whereHelper__byte{field: "\"user_credentials\".\"hash\""},
	UpdatedAt: whereHelpertime_Time{field: "\"user_credentials\".\"updated_at\""},
}
...
var (
	userCredentialAllColumns            = []string{"tenant_id", "user_id", "algorithm", "params", "salt", "hash", "updated_at"}
	userCredentialColumnsWithoutDefault = []string{"tenant_id", "user_id", "algorithm", "params", "salt", "hash"}
	userCredentialColumnsWithDefault    = []string{"updated_at"}
	userCredentialPrimaryKeyColumns     = []string{"tenant_id", "user_id"}
...
func (q userCredentialQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserCredential, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbpostgres: failed to execute a one query for user_credentials")
	}
...
func (q userCredentialQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserCredentialSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbpostgres: failed to assign all query results to UserCredential slice")
	}
...
func (q userCredentialQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to count user_credentials rows")
	}
...
func (q userCredentialQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbpostgres: failed to check if user_credentials exists")
	}
...
func FindUserCredential(ctx context.Context, exec boil.ContextExecutor, tenantID string, userID string, selectCols ...string) (*UserCredential, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"user_credentials\" where \"tenant_id\"=$1 AND \"user_id\"=$2", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbpostgres: unable to select from user_credentials")
	}
...
func (o *UserCredential) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbpostgres: no user_credentials provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to insert into user_credentials")
	}
...
func (o *UserCredential) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbpostgres: unable to update user_credentials, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update user_credentials row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by update for user_credentials")
	}
...
func (q userCredentialQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update all for user_credentials")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to retrieve rows affected for user_credentials")
	}
...
func (o UserCredentialSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update all in userCredential slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to retrieve rows affected all in update all userCredential")
	}
	return rowsAff, nil
}
...
func (o *UserCredential) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dbpostgres: no user_credentials provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbpostgres: unable to upsert user_credentials, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userCredentialPrimaryKeyColumns) == 0 {
				return errors.New("dbpostgres: unable to upsert user_credentials, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to upsert user_credentials")
	}
...
func (o *UserCredential) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbpostgres: no UserCredential provided for delete")
	}
	...
	sql := "DELETE FROM \"user_credentials\" WHERE \"tenant_id\"=$1 AND \"user_id\"=$2"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete from user_credentials")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by delete for user_credentials")
	}
...
func (q userCredentialQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbpostgres: no userCredentialQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete all from user_credentials")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by deleteall for user_credentials")
	}
...
func (o UserCredentialSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete all from userCredential slice")
	}
...
func (o *UserCredential) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUserCredential(ctx, exec, o.TenantID, o.UserID)
	if err != nil {
		return err
	}
...
func (o *UserCredentialSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to reload all in UserCredentialSlice")
	}
...
func UserCredentialExists(ctx context.Context, exec boil.ContextExecutor, tenantID string, userID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"user_credentials\" where \"tenant_id\"=$1 AND \"user_id\"=$2 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbpostgres: unable to check if user_credentials exists")
	}
...
func (o *UserCredential) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserCredentialExists(ctx, exec, o.TenantID, o.UserID)
}
